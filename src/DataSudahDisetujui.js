...
export default class DataBelumDisetujui extends Component {
    ...
    async getIndex() {
        ...
        return fetch(baseApi + 'kebakaran?id_kab='+id_kab+'&status=1').then((response) => response.json()).then((responseJson) => {
            this.setState({
                loading: false,
    ...
    renderRow = ({item, index}) => {
        ...
        return (
            <ListItem
                onPress={() => {
                    this.props.navigation.navigate('DataSudahDisetujuiDetail',{'dataItem':item})
                }}
                ...
                <ListItem.Content>
                    ...
                    <ListItem.Subtitle style={{fontSize: 17}}>{moment(item.created_at).startOf('day').fromNow()}</ListItem.Subtitle>
        ...
        return (
            <View style={{flex: 1}}>
                ...
                <Header
                    ...
                    placement="center"
                    centerComponent={{text: 'Data Sudah Di Tindak Lanjuti', style: {color: '#fff', fontWeight: 'bold'}}}
                />
                {/*<SearchBar*/}
                ...
                <Modal
                    ...
                    <ScrollView style={{flex: 1}}>
                        <View style={{backgroundColor: 'white', padding: 5,flex: 1,
                            ...
                            {/*    buttonStyle={{backgroundColor:'#b50000',height:30,borderRadius:20,width:200}}*/}
                            {/*    // icon={*/}
                            {/*    //     <Icon*/}
                            {/*    //         name="phone"*/}
                            {/*    //         size={15}*/}
                        ...
                        <MapView
                            style={{width:Dimensions.get('screen').width,height:200,margin:10}}
                            initialRegion={{
